...
// Fixed: Mobile Alabama removed, hours removed, proper social icons,
// gold newsletter button, correct margins, organic/skincare capitalization
...
function FooterNewsletter() {
  ...
  if (status === "success") {
    return <p className="text-[#C9A96E] text-sm font-sans italic">You&apos;re in. Check your inbox. ✨</p>;
  }
  return (
    <form onSubmit={submit} className="flex gap-0">
      <input
        ...
        className="flex-1 px-3.5 py-3 bg-[#1E1E1C] border border-[#2E2E2C] text-white
                   placeholder-[#4A4A48] text-sm font-sans
                   focus:outline-none focus:border-[#C9A96E] transition-colors min-w-0"
      />
      <button type="submit" disabled={status === "loading"}
        className="px-5 py-3 bg-[#C9A96E] text-[#1C1C1A] text-[10px] tracking-[0.18em]
                   uppercase font-sans font-medium hover:bg-[#D4AF88] disabled:opacity-50
    ...
    <footer className="bg-[#111110]">
      ...
      <div className="max-w-[1320px] mx-auto px-5 sm:px-8 lg:px-12 py-16 lg:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-14">
          ...
          <div>
            ...
            <ul className="space-y-3.5">
              {[
                ...
                <li key={label}>
                  <Link href={href}
                    className="text-[#4A4A48] text-sm font-sans hover:text-[#C9A96E] transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-sans">
              ...
              <li className="text-[#4A4A48] leading-relaxed pt-1">
                New Orleans, Louisiana
              </li>
              <li className="text-[#4A4A48] text-xs pt-1">
                By appointment only
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-[#4A4A48] text-sm font-sans mb-4 leading-relaxed">
        ...
        <div className="border-t border-[#1C1C1A] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[#333] text-xs font-sans">© 2026 Epoch Skin. All rights reserved.</p>
          <div className="flex gap-6">
            {[
              ...
              <Link key={label} href={href}
                className="text-[#333] text-xs font-sans hover:text-[#C9A96E] transition-colors">
                {label}
              </Link>
            ))}
          </div>
