...
<div>
  ...
  <ul className="space-y-3">
    <li className="flex items-center gap-2">
      <svg className="w-5 h-5 text-clay-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <li className="flex items-center gap-2">
      <svg className="w-5 h-5 text-clay-300 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
    ...
    <li className="flex items-center gap-2">
      ...
      <a 
        href="https://facebook.com/epoch_skin" 
        target="_blank"
        rel="noopener noreferrer"
        className="hover:text-clay-300 transition-colors"
      >
