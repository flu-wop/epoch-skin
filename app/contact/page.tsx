              ...
              <div className="bg-white rounded-lg p-8 shadow-sm">
                ...
                <div className="flex items-start space-x-4 mb-6">
                  ...
                  <div>
                    ...
                    <a href="mailto:kayla@epoch-skin.com" className="text-[#b87968] hover:underline text-lg">
                ...
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-[#b87968]/10 rounded-full flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-[#b87968]" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <h3 className="text-lg font-serif text-gray-900 mb-2">Follow Us</h3>
                    <a 
                      href="https://instagram.com/epoch_skin" 
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-[#b87968] hover:underline text-lg"
                    >
                      @epoch_skin
                    </a>
                  </div>
